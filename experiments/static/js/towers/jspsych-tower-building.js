...
jsPsych.plugins["jspsych-tower-building"] = (function () {
  var plugin = {};

  // jsPsych.pluginAPI.registerPreload('tower-display', 'stimulus');

  plugin.info = {
    name: "jspsych-tower-building",
    parameters: {
      stimURL: {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    // show preamble text
    html_content = '<h3 style="align:center"> ${trial.label_prompt} </h3>';

    // stimulus and building canvases
    html_content += '<div class="any-canvas" id="stimulus-canvas" style="display: inline-block"></div>';
    html_content += '<div class="any-canvas" id="environment-canvas" style="display: inline-block"></div>';
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      html_content += '<p class="jspsych-survey-text">' + question.prompt;
