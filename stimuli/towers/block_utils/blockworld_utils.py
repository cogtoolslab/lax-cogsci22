...
def draw_world(world,**kwargs):
    return render_blockworld(patches_for_world(world.blocks), world.world_width, world.world_height,**kwargs) 
...
def render_blockworld(patches,
    ...
    if figsize == None:
        figsize = (world_width/2, world_height/2)
